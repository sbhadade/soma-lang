...
#define SOM_ROWS    16
#define SOM_COLS    16
#define MAX_AGENTS  255
#define VEC_DIM     8
#define N_INSTRS    23
#define DATA_FLOATS 67
...
static const Instr g_code[23] = {
  {0x1c,0x00,0x00,0x00,0x00000000}, /* SOM_INIT @ 0x20 */
  {0x03,0x00,0x10,0x00,0x00000060}, /* FORK @ 0x28 */
  {0x23,0x00,0x00,0x00,0x0000beef}, /* BROADCAST @ 0x30 */
  {0x05,0x00,0x00,0x00,0x00000010}, /* BARRIER @ 0x38 */
  {0x04,0x00,0x00,0x00,0x00000000}, /* MERGE @ 0x40 */
  {0x19,0x00,0x00,0x00,0x00000000}, /* SOM_ELECT @ 0x48 */
  {0x41,0x00,0x00,0x00,0x80000100}, /* STORE @ 0x50 */
  {0x37,0x00,0x00,0x00,0x00000000}, /* HALT @ 0x58 */
  {0x21,0x00,0x00,0x00,0x00000000}, /* MSG_RECV @ 0x60 */
  {0x40,0x00,0x00,0x01,0x00000000}, /* MOV @ 0x68 */
  {0x40,0x00,0x00,0x02,0x00000040}, /* MOV @ 0x70 */
  {0x33,0x00,0x01,0x02,0x000000b8}, /* JEQ @ 0x78 */
  {0x43,0x00,0x00,0x00,0x00000020}, /* TRAP @ 0x80 */
  {0x11,0x00,0x00,0x03,0x00000000}, /* SOM_BMU @ 0x88 */
  {0x1d,0x00,0x00,0x00,0x00000000}, /* SOM_WALK @ 0x90 */
  {0x12,0x00,0x00,0x00,0x00000000}, /* SOM_TRAIN @ 0x98 */
  {0x1f,0x00,0x00,0x00,0x00000001}, /* LR_DECAY @ 0xa0 */
  {0x50,0x00,0x01,0x01,0x00000001}, /* ADD @ 0xa8 */
  {0x30,0x00,0x00,0x00,0x00000070}, /* JMP @ 0xb0 */
  {0x1b,0x00,0x00,0x04,0x00000000}, /* SOM_SENSE @ 0xb8 */
  {0x24,0x00,0x04,0x00,0x00000000}, /* ACCUM @ 0xc0 */
  {0x20,0xff,0x00,0x00,0x00000000}, /* MSG_SEND @ 0xc8 */
  {0x02,0x00,0x00,0x00,0x000000fe}, /* AGENT_KILL @ 0xd0 */
};
